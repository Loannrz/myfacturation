...
export default function NouvelleFacturePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <Link href="/factures" className="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-black mb-6">
        <ArrowLeft className="w-4 h-4" />
        Retour aux factures
      </Link>
      <h1 className="text-2xl font-semibold text-black mb-6">Nouvelle facture</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-4">
          ...
          <Link href="/factures" className="px-4 py-2 rounded-lg border border-gray-300 text-black font-medium hover:bg-gray-50">
            Annuler
          </Link>
        </div>
      </form>
